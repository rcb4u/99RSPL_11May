...
import Adapter.ReportMonthlySaleListAdapter;
import Pojo.Decimal;
import Pojo.SaleReportModel;


public class ShowMonthlySalesReportListActivity extends Activity {

    ListView listView;
    ReportMonthlySaleListAdapter salelistAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_monthlyreportsale_list);
        ...
        helper = new DBhelper(ShowMonthlySalesReportListActivity.this);

        Bundle extras = getIntent().getExtras();
        String Value = extras.getString("id");
        alldata=helper.getMonthlySalesBillDetailReport(Value);


        listView = (ListView) findViewById(R.id.lv_MonthlySalesReport);
        Log.e("***********Lt1*******", listView.toString());

        salelistAdapter=new ReportMonthlySaleListAdapter(this,alldata,android.R.layout.simple_expandable_list_item_1,null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            /*Intent i=new Intent(ShowMonthlySalesReportListActivity.this, ReportTabActivitySalesReport.class);
            startActivity(i);*/
            onBackPressed();
            return true;
        }
        ...
        if(id==R.id.action_settinginfo){
            ShowIncentive showIncentive = new ShowIncentive(ShowMonthlySalesReportListActivity.this);
            showIncentive.show();
            return true;
        }
