...
public class ShowWeeklySalesReportListActivity extends Activity {

    ListView listView;
    ReportWeeklySaleListAdapter salelistAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_weeklyreportsale_list);
        ...
        alldata=helper.getWeeklySalesBillDetailReport(Value);


        listView = (ListView) findViewById(R.id.lv_WeeklySalesReport);
        Log.e("***********Lt1*******", listView.toString());

        salelistAdapter=new ReportWeeklySaleListAdapter(this,alldata,android.R.layout.simple_expandable_list_item_1,null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            /*Intent i=new Intent(ShowWeeklySalesReportListActivity.this, ReportTabActivitySalesReport.class);
            startActivity(i);*/
            onBackPressed();
            return true;
        }
        ...
        if(id==R.id.action_settinginfo){
            ShowIncentive showIncentive = new ShowIncentive(ShowWeeklySalesReportListActivity.this);
            showIncentive.show();
            return true;
        }
