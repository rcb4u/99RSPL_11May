...
public class CustomAlphaNumericKeyboard  {
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if( focusCurrent==null || focusCurrent.getClass()!=CustomAuto.class ) return;
            CustomAuto edittext = (CustomAuto) focusCurrent;
...
//
    ...
    public CustomAlphaNumericKeyboard(Activity host, int viewid, int layoutid) {
        mHostActivity= host;
    ...
    public void registerEditText(int resid) {
        ...
        CustomAuto edittext= (CustomAuto) mHostActivity.findViewById(resid);
