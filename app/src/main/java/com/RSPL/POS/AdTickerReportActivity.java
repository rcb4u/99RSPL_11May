    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                arrayAdTickerList = helper.MediaAdTickerReport(fromString, toString);
...
if(id==R.id.action_settinginfo) {
    ShowIncentive showIncentive = new ShowIncentive(AdTickerReportActivity.this);
    showIncentive.show();
    return true;
}
    ...
    public void insertEmaildata() {
        try {
            ...
            dBhelper.insertemailAdticker(AdTickerListAdapter.getList());
    ...
    public void Updateadtickerlistsreport() {


        for (AdTickerReportModel purchase : AdTickerListAdapter.getList()) {
...
try{
                    ...
                    JSONObject s = rh.sendPostRequest("http://52.76.28.14/E_mail/retail_ad_ticker_mail.php", hashMap);
