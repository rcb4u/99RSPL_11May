...
import Adapter.ReportYearlySaleListAdapter;
import Pojo.Decimal;
import Pojo.SaleReportModel;


public class ShowYearlySalesReportListActivity extends Activity {

    ListView listView;
    ReportYearlySaleListAdapter salelistAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_yearlyreportsale_list);
        ...
        alldata=helper.getYearlySalesBillDetailReport(Value);


        listView = (ListView) findViewById(R.id.lv_YearlySalesReport);
        Log.e("***********Lt1*******", listView.toString());

        salelistAdapter=new ReportYearlySaleListAdapter(this,alldata,android.R.layout.simple_expandable_list_item_1,null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
          ...
          /*  Intent i=new Intent(ShowYearlySalesReportListActivity.this, ReportTabActivitySalesReport.class);
            startActivity(i);*/
            onBackPressed();
            return true;
        }
        if(id==R.id.action_settinginfo){
        ShowIncentive showIncentive = new ShowIncentive(ShowYearlySalesReportListActivity.this);
        showIncentive.show();
        return true;
    }
