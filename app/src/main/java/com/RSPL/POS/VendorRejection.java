...
public class VendorRejection extends Activity {
    ...
    ArrayList<VendorRejectModel> arrayList;
...
TextView tvreason,tvreasonofrejection,tvactive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new DBhelper(VendorRejection.this);
...
////////////////////////////////////jimmy//////////////////////////////////////////////
        ...
        editVReason = (EditText) findViewById(R.id.editVReason);
        ...
        storeid = (TextView) findViewById(R.id.VstoreId);
        ...
        mydb = new DBhelper(VendorRejection.this);
        ArrayList<VendorRejectModel> reasonReturn = mydb.getVRejectReason();

        ArrayAdapter<VendorRejectModel> stringArrayAdapter =
                new ArrayAdapter<VendorRejectModel>(VendorRejection.this, android.R.layout.simple_spinner_dropdown_item, reasonReturn);
        ...
        mreasone.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                mydb = new DBhelper(VendorRejection.this);
                VendorRejectModel value = (VendorRejectModel) parent.getItemAtPosition(position);
                ...
                //  SpinValue = value.getActive();
                //SpinValue = setText(value.getActive());
...
//                }
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActiveType = getResources().getStringArray(R.array.active_Status);
                adapteractiveType = new ArrayAdapter<String>(VendorRejection.this, android.R.layout.simple_spinner_item, ActiveType);
                adapteractiveType.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
             active.setAdapter(adapteractiveType);*/
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    //   String Value2 = mreasone.getSelectedItem().toString();



                    mydb.updatemVendorRejectReason(mVID.getText().toString(),editVReason.getText().toString(),SpinValue,user2.getText().toString());
                    Updatevendorrejection();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ArrayAdapter<Registeremployeesmodel > stringArrayAdapter =
                new ArrayAdapter<Registeremployeesmodel>(VendorRejection.this, android.R.layout.simple_spinner_dropdown_item,user_name);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_settings:
                ...
                Intent i=new Intent(VendorRejection.this,ActivityLoyality.class);
                startActivity(i);

                return true;
            case R.id.action_settinginfo:
                ShowIncentive showIncentive = new ShowIncentive(VendorRejection.this);
                showIncentive.show();
                return true;
            case R.id.action_settinghelp:
                help_vendor_Reason_for_Rejection();
                return true;

           /* case R.id.action_settingpurchase:
                Intent p=new Intent(VendorRejection.this,PurchaseActivity.class);
                startActivity(p);
                return true;
*/
            case R.id.action_Masterscn1:
                Intent p = new Intent(VendorRejection.this, Activity_masterScreen1.class);
                startActivity(p);
                return true;
            case R.id.action_settinginv:
                Intent in=new Intent(VendorRejection.this,InventoryTotalActivity.class);
                startActivity(in);
                return true;

            case R.id.action_settingsales:
                Intent s=new Intent(VendorRejection.this,ActivitySalesbill.class);
                startActivity(s);
                return true;
    ...
    public void Logout()
    {
        Intent intent = new Intent(VendorRejection.this ,login.class);
        startActivity(intent);
    }



    public void Updatevendorrejection() {



        final String rejectionid =  mVID.getText().toString();
        final String rejectionreason =editVReason.getText().toString();
        final String rejectionpinvalue =  SpinValue.toString();
        final String pos_user = user2.getText().toString();


        PersistenceManager.saveStoreId(VendorRejection.this, mydb.getStoreid().toString().replace("[", "").replace("]", ""));
        store_id = PersistenceManager.getStoreId(VendorRejection.this);



        class UpdateVenderrejection extends AsyncTask<Void, Void, String> {
...
try{
                ...
                hashMap.put(Config.rejection_storeid,store_id);
                hashMap.put(Config.rejection_id,rejectionid);
                hashMap.put(Config.rejection_reason,rejectionreason);
                hashMap.put(Config.rejection_spinvalue,rejectionpinvalue);
                hashMap.put(Config.Retail_Pos_user,pos_user);


                JSONParserSync rh = new JSONParserSync();
                JSONObject s = rh.sendPostRequest(Config.VENDOR_REJECTION, hashMap);
            ...
            protected void onPostExecute(String s) {
                ...
                //     loading.dismiss();
               // Toast.makeText(VendorRejection.this, s, Toast.LENGTH_LONG).show();
            }

        }
        UpdateVenderrejection updatepointrange = new UpdateVenderrejection();
    ...
    public void help_vendor_Reason_for_Rejection() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(this);

        // Setting Dialog Title
        // alertDialog.setTitle("Confirm Delete...");
        alertDialog.setIcon(R.drawable.alertimage);
        alertDialog.setTitle("               VENDOR REASON FOR REJECTION");
        alertDialog.setMessage(" \n" +
                        "Objective:\n" +
                        "\t\n" +
                        "There are 10 reasons provided why vendor can reject or return a product. The store personnel can update the same.\n" +
