...
public class McashMainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcashmain);
    ...
    public void PingProcess(){
        ...
        class WaitingforResponse extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                loading = ProgressDialog.show(McashMainActivity.this, "Waiting for Response Ping...", "Please Wait...", false, false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                Response response = client.newCall(request).execute();
                    //   Toast.makeText(McashMainActivity.this, "the response from server"+response, Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        if(v==CashOut)
        {
            Intent intent = new Intent(McashMainActivity.this, CashOut.class);
            startActivity(intent);

        }if(v==CashIn){
            Intent intent = new Intent(McashMainActivity.this, CashIn.class);
            startActivity(intent);
        }if(v==PayforGoods)
        {
            Intent intent = new Intent(McashMainActivity.this, PayForGoodsActivity.class);
            startActivity(intent);
        }
    }
}
