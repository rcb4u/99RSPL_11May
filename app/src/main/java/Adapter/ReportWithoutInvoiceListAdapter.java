...
public class ReportWithoutInvoiceListAdapter extends BaseAdapter
{
    ...
    ShowWithoutInvoiceReportListActivity activity;
    ...
    public ReportWithoutInvoiceListAdapter(ShowWithoutInvoiceReportListActivity activity, ArrayList<SalesReturnReportModel> list, int layoutResourceId, SalesReturnReportModel salesReturnReportModel1) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.display_full_withoutinvoice_grandtotal_row,parent,false);
