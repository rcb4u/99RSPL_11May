...
/**
 * Created by rspl-abhinay on 21/12/16.
 */

public class Inventoryinventorygrnadapter extends BaseAdapter
{
    ...
    public Inventoryinventorygrnadapter( activity_inventory activity, int textViewResourceId, ArrayList<Inventorygrnmodel> objects) {
