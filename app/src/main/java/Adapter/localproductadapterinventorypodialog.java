 ...
 */
public class localproductadapterinventorypodialog extends ArrayAdapter<LocalProduct> {
    ...
    public localproductadapterinventorypodialog(activity_inventorywithpo activity, int layoutResourceId, ArrayList<LocalProduct> mlocalproductlist) {
