...
public class ReportWeeklySaleListAdapter extends BaseAdapter
{

    ShowWeeklySalesReportListActivity activity;
    ...
    public ReportWeeklySaleListAdapter(ShowWeeklySalesReportListActivity activity, ArrayList<SaleReportModel> list, int layoutResourceId, SaleReportModel purchaseProductModel) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.display_full_weeklysales_grandtotal_row,parent,false);
