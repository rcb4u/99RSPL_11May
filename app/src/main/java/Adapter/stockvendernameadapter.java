...
/**
 * Created by rspl-gourav on 8/9/16.
 *
 */
public class stockvendernameadapter    extends ArrayAdapter<Inventorymodel> {
    ...
    public stockvendernameadapter(StockAdjustment activity, int textViewResourceId, ArrayList<Inventorymodel> objects) {
