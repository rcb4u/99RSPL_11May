...
public class ReportPurchaseList1MonthAdapter extends BaseAdapter
{

    ShowPurchaseReport1MonthListActivity activity;
    ...
    public ReportPurchaseList1MonthAdapter(ShowPurchaseReport1MonthListActivity activity, ArrayList<PurchaseProductReportModel> list, int layoutResourceId, PurchaseProductReportModel purchaseProductModel) {
