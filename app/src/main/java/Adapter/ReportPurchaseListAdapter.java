...
public class ReportPurchaseListAdapter extends BaseAdapter
{
    ...
    ShowPurchaseReportListActivity activity;
    ...
    public ReportPurchaseListAdapter(ShowPurchaseReportListActivity activity, ArrayList<PurchaseProductReportModel> list, int layoutResourceId, PurchaseProductReportModel purchaseProductModel) {
