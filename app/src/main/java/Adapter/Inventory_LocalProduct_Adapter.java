...
import com.RSPL.POS.Dialog_Inventory_Localproduct;
...
/**
 * Created by rspl-abhigyan on 10/3/16.
 */
public class Inventory_LocalProduct_Adapter  extends ArrayAdapter<LocalProduct>{


    private final int layoutResourceId;
    private Context mcontext;
    Dialog_Inventory_Localproduct activity;
    private LayoutInflater mInflater;
    TextView tv;
    TextView v;

    public Inventory_LocalProduct_Adapter(Dialog_Inventory_Localproduct activity, int layoutResourceId, ArrayList<LocalProduct> mlocalproductlist) {
