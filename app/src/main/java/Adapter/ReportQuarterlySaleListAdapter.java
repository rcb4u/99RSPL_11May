...
public class ReportQuarterlySaleListAdapter extends BaseAdapter
{

    ShowQuarterlySalesReportListActivity activity;
    ...
    public ReportQuarterlySaleListAdapter(ShowQuarterlySalesReportListActivity activity, ArrayList<SaleReportModel> list, int layoutResourceId, SaleReportModel purchaseProductModel) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.display_full_quarterlysales_grandtotal_row,parent,false);
