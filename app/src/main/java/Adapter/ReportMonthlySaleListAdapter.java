...
public class ReportMonthlySaleListAdapter extends BaseAdapter
{

    ShowMonthlySalesReportListActivity activity;
    ...
    public ReportMonthlySaleListAdapter(ShowMonthlySalesReportListActivity activity, ArrayList<SaleReportModel> list, int layoutResourceId, SaleReportModel purchaseProductModel) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.display_full_monthlysales_grandtotal_row,parent,false);
