...
import ReportTabFragments.FragmentStockSearchAdapter;

/**
 * Created by rspl-rahul on 3/2/17.
 */

public class FragmentStockVendorInvoiceAdapter extends ArrayAdapter<StockInventoryReportModel> {
    ArrayList<StockInventoryReportModel> idList;
    private Context context;
    private int resource;
    private View view;

    public FragmentStockVendorInvoiceAdapter(Context context, int resource, ArrayList<StockInventoryReportModel> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ViewHolder holder;
        ...
        holder.DstrNm.setText(idList.get(position).getVendInvoiceNo());
        return convertView;
    }
