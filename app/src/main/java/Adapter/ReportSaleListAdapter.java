...
public class ReportSaleListAdapter extends BaseAdapter
{
    ...
    ShowSalesReportListActivity activity;
    ...
    public ReportSaleListAdapter(ShowSalesReportListActivity activity, ArrayList<SaleReportModel> list, int layoutResourceId, SaleReportModel purchaseProductModel) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.display_full_sales_grandtotal_row,parent,false);
