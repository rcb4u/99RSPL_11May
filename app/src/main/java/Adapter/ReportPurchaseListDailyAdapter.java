...
public class ReportPurchaseListDailyAdapter extends BaseAdapter
{

    ShowPurchaseReportDailyListActivity activity;
    ...
    public ReportPurchaseListDailyAdapter(ShowPurchaseReportDailyListActivity activity, ArrayList<PurchaseProductReportModel> list, int layoutResourceId, PurchaseProductReportModel purchaseProductModel) {
