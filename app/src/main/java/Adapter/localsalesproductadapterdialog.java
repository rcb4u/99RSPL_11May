...
/**
 * Created by rspl on 30/9/16.
 */
public class localsalesproductadapterdialog extends ArrayAdapter<LocalProduct> {
    ...
    public localsalesproductadapterdialog(ActivitySalesbill activity, int layoutResourceId, ArrayList<LocalProduct> mlocalproductlist) {
