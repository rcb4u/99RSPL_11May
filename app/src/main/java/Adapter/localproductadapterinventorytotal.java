...
/**
 * Created by rspl-rahul on 27/12/16.
 */

public class localproductadapterinventorytotal extends ArrayAdapter<LocalProduct> {
    ...
    public localproductadapterinventorytotal(InventoryTotalActivity activity, int layoutResourceId, ArrayList<LocalProduct> mlocalproductlist) {
...
//                .getSystemService(Context.LAYOUT_INFvendorlistR_SERVICE);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        localproductadapterinventorydialog.ViewHolder holder;

        if (convertView == null) {

            holder = new localproductadapterinventorydialog.ViewHolder();
            ...
            holder = (localproductadapterinventorydialog.ViewHolder) convertView.getTag();
        }
