...
public class InventoryTotalLocalVendoradapter extends ArrayAdapter<localvendor> {
    ...
    public InventoryTotalLocalVendoradapter(InventoryTotalActivity activity, int layoutResourceId, ArrayList<localvendor> mlocalvendorlist) {
...
//                .getSystemService(Context.LAYOUT_INFvendorlistR_SERVICE);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Withoutpo_localvendoradapter.ViewHolder holder;

        if (convertView == null) {

            holder = new Withoutpo_localvendoradapter.ViewHolder();
            ...
            holder = (Withoutpo_localvendoradapter.ViewHolder) convertView.getTag();
        }
