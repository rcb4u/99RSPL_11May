...
import com.RSPL.POS.Dialog_Inventory_Localvendor;
 ...
 */
public class Dialoginventory_adapter extends ArrayAdapter<localvendor> {
    ...
    Dialog_Inventory_Localvendor activity;
    private LayoutInflater mInflater;
    TextView tv;
    TextView v;

    public Dialoginventory_adapter(Dialog_Inventory_Localvendor activity, int layoutResourceId, ArrayList<localvendor> mlocalvendorlist) {
