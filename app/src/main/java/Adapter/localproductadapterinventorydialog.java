 ...
 */
public class localproductadapterinventorydialog extends ArrayAdapter<LocalProduct> {
    ...
    public localproductadapterinventorydialog(activity_inventory activity, int layoutResourceId, ArrayList<LocalProduct> mlocalproductlist) {
