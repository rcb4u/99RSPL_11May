 ...
 */
public class Withpo_localvendoradapter extends ArrayAdapter<localvendor> {
    ...
    public Withpo_localvendoradapter(activity_inventorywithpo activity, int layoutResourceId, ArrayList<localvendor> mlocalvendorlist) {
