...
public class FragmentListSalesAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<SaleReportModel> list = new ArrayList<SaleReportModel>();
    public Context context;
    FragmentSalesReport fragmentSalesReport;
    DBhelper mydb;

    public FragmentListSalesAdapter(ArrayList<SaleReportModel> list, Context context, FragmentSalesReport fragmentSalesReport) {
        this.list = list;
        this.context = context;
        this.fragmentSalesReport=fragmentSalesReport;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.display_custom_grandtotal_row, null);
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentSalesReport.GetDetailPage(holder.TV_TRIID.getText().toString());

            }
        });

        fragmentSalesReport.setSummaryRow();
        return convertView;
    }
