...
public class FragmentListYearlySalesAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<SaleReportModel> list = new ArrayList<SaleReportModel>();
    private Context context;
    FragmentYearlySalesReport fragmentYearlySalesReport;
    DBhelper mydb;


    public FragmentListYearlySalesAdapter(ArrayList<SaleReportModel> list, Context context, FragmentYearlySalesReport fragmentYearlySalesReport) {
        this.list = list;
        this.context = context;
        this.fragmentYearlySalesReport=fragmentYearlySalesReport;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.display_yearlysales_grandtotal_row, null);
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentYearlySalesReport.GetYearlyDetailPage(holder.TV_TRIID.getText().toString());
            }
        });
        ...
        holder.mPrintBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentYearlySalesReport.printBillDialog(holder.TV_TRIID.getText().toString());
            }
        });
        return convertView;
    }
