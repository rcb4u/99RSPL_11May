...
public class FragmentListWithInvoiceAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<SalesReturnReportModel> list = new ArrayList<SalesReturnReportModel>();
    public Context context;
    FragmentWithInvoiceReport fragmentWithInvoiceReport;
    DBhelper mydb;


    public FragmentListWithInvoiceAdapter(ArrayList<SalesReturnReportModel> list, Context context, FragmentWithInvoiceReport fragmentWithInvoiceReport) {
        this.list = list;
        this.context = context;
        this.fragmentWithInvoiceReport = fragmentWithInvoiceReport;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentWithInvoiceReport.GetWithInvoiceDetailPage(holder.TV_TRANSID.getText().toString());
            }
        });
