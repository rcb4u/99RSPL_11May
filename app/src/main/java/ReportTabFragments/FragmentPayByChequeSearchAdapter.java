...
public class FragmentPayByChequeSearchAdapter extends ArrayAdapter<PayByChequeVendorPaymentModel>{

    ArrayList<PayByChequeVendorPaymentModel> idList;
    private Context context;
    private int resource;
    private View view;

    public FragmentPayByChequeSearchAdapter(Context context, int resource, ArrayList<PayByChequeVendorPaymentModel> objects) {
    ...
    public PayByChequeVendorPaymentModel getItem(int position) {
