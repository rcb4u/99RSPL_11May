...
public class FragmentListWeeklySalesAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<SaleReportModel> list = new ArrayList<SaleReportModel>();
    private Context context;
     FragmentWeeklySalesReport fragmentWeeklySalesReport;
    DBhelper mydb;

    public FragmentListWeeklySalesAdapter(ArrayList<SaleReportModel> list, Context context, FragmentWeeklySalesReport fragmentWeeklySalesReport) {
        this.list = list;
        this.context = context;
        this.fragmentWeeklySalesReport=fragmentWeeklySalesReport;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.display_weeklysales_grandtotal_row, null);
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentWeeklySalesReport.GetWeeklyDetailPage(holder.TV_TRIID.getText().toString());
        ...
        holder.mPrintBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentWeeklySalesReport.printBillDialog(holder.TV_TRIID.getText().toString());
            }
        });
        return convertView;
    }
