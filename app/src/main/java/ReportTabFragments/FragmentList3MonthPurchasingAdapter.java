...
public class FragmentList3MonthPurchasingAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<VendorReportModel> list = new ArrayList<VendorReportModel>();
    FragmentPurchasing3MonthReport fragmentPurchasing3MonthReport;
    private Context context;

    public FragmentList3MonthPurchasingAdapter(ArrayList<VendorReportModel> list, Context context,FragmentPurchasing3MonthReport fragmentPurchasing3MonthReport1) {
        this.list = list;
        this.context = context;
        this.fragmentPurchasing3MonthReport = fragmentPurchasing3MonthReport1;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentPurchasing3MonthReport.GetQuarterlyDetailPage(holder.TVPO_NO.getText().toString());
            }
        });
        return convertView;
    }
