...
public class FragmentPayByChequeListAdapter extends BaseAdapter{
    ...
    public FragmentPayByChequeListAdapter(ArrayList<PayByChequeVendorPaymentModel> list, Context context) {
        super();
        this.list = list;
