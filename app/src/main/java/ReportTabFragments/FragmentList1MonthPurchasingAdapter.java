...
public class FragmentList1MonthPurchasingAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<VendorReportModel> list = new ArrayList<VendorReportModel>();
    private Context context;
    FragmentPurchasing1MonthReport fragmentPurchasing1MonthReport;


    public FragmentList1MonthPurchasingAdapter(ArrayList<VendorReportModel> list, Context context,FragmentPurchasing1MonthReport fragmentPurchasing1MonthReport1) {
        this.list = list;
        this.context = context;
        this.fragmentPurchasing1MonthReport = fragmentPurchasing1MonthReport1;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentPurchasing1MonthReport.GetMonthlyDetailPage(holder.TVPO_NO.getText().toString());
            }
        });
        return convertView;
    }
