...
public class FragmentPayByCashList1MonthAdapter extends BaseAdapter{

    LayoutInflater layoutInflater;
    ArrayList<PayByCashVendorPaymentModel> list = new ArrayList<PayByCashVendorPaymentModel>();
    private  Context context;
    FragmentPayByCash1MonthReport fragmentPayByCash1MonthReport;
    DBhelper mydb;

    public FragmentPayByCashList1MonthAdapter(ArrayList<PayByCashVendorPaymentModel> list, Context context, FragmentPayByCash1MonthReport fragmentPayByCash1MonthReport1) {
        super();
        this.list = list;
