...
public class FragmentListQuarterlySalesAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    ArrayList<SaleReportModel> list = new ArrayList<SaleReportModel>();
    private Context context;
    FragmentQuarterlySalesReport fragmentQuarterlySalesReport;
    DBhelper mydb;

    public FragmentListQuarterlySalesAdapter(ArrayList<SaleReportModel> list, Context context, FragmentQuarterlySalesReport fragmentQuarterlySalesReport) {
        this.list = list;
        this.context = context;
        this.fragmentQuarterlySalesReport=fragmentQuarterlySalesReport;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.display_quarterlysales_grandtotal_row, null);
        ...
        holder.View_Details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentQuarterlySalesReport.GetQuarterlyDetailPage(holder.TV_TRIID.getText().toString());
        ...
        holder.mPrintBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentQuarterlySalesReport.printBillDialog(holder.TV_TRIID.getText().toString());
            }
        });
