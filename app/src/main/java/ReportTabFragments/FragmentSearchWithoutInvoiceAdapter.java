...
public class FragmentSearchWithoutInvoiceAdapter extends ArrayAdapter<SalesReturnReportModel> {
    ...
    public FragmentSearchWithoutInvoiceAdapter(Context context, int resource, ArrayList<SalesReturnReportModel> objects)
    {
