...
public class FragmentPayByChequeList6MonthAdapter extends BaseAdapter{

    LayoutInflater layoutInflater;
    ArrayList<PayByChequeVendorPaymentModel> list = new ArrayList<PayByChequeVendorPaymentModel>();
    private  Context context;
    FragmentPayByCheque6MonthReport fragmentPayByCheque1MonthReport;
    DBhelper mydb;

    public FragmentPayByChequeList6MonthAdapter(ArrayList<PayByChequeVendorPaymentModel> list, Context context,FragmentPayByCheque6MonthReport fragmentPayByCheque1MonthReport1) {
        super();
        this.list = list;
