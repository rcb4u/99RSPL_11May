...
public class FragmentPayByCashList6MonthAdapter extends BaseAdapter{

    LayoutInflater layoutInflater;
    ArrayList<PayByCashVendorPaymentModel> list = new ArrayList<PayByCashVendorPaymentModel>();
    private  Context context;
    FragmentPayByCash6MonthReport fragmentPayByCash1MonthReport;
    DBhelper mydb;

    public FragmentPayByCashList6MonthAdapter(ArrayList<PayByCashVendorPaymentModel> list, Context context, FragmentPayByCash6MonthReport fragmentPayByCash1MonthReport1) {
        super();
        this.list = list;
