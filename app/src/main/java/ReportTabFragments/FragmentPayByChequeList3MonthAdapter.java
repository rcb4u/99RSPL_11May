...
public class FragmentPayByChequeList3MonthAdapter extends BaseAdapter{

    LayoutInflater layoutInflater;
    ArrayList<PayByChequeVendorPaymentModel> list = new ArrayList<PayByChequeVendorPaymentModel>();
    private  Context context;
    FragmentPayByCheque3MonthReport fragmentPayByCheque1MonthReport;
    DBhelper mydb;

    public FragmentPayByChequeList3MonthAdapter(ArrayList<PayByChequeVendorPaymentModel> list, Context context,FragmentPayByCheque3MonthReport fragmentPayByCheque1MonthReport1) {
        super();
        this.list = list;
