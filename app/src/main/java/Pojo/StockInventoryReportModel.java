...
public class StockInventoryReportModel {
    ...
    String VendInvoiceNo;

    public String getVendInvoiceNo() {
        return VendInvoiceNo;
    }

    public void setVendInvoiceNo(String vendInvoiceNo) {
